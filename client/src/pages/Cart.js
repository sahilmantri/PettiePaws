...
const Cart = () => {
  ...
  const payment = async () => {
    const res = await axios.post("http://localhost:8000/pay", (productData));
          ...
          <div className="w-1/3 bg-[#fafafa] py-6 px-4">
            ...
            {payNow && (
              <div className="w-full mt-6 flex items-center justify-center">
                ...
                {/* <StripeCheckout
                  stripeKey="pk_test_51MrFB2SDsLpzhLFaTSnkOtt35FRf62XUzCDFfyqZKmsH7d3scKL069kXrsvwJh9NFXj4nePBSxrtXe826kvavQCj00pnBBDbJY"
